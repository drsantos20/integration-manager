		...
		<div class="body">
			<div id="page-content">
			 <div class="container">
				...
				<form:form id="demo-form" class="form-horizontal" data-parsley-validate="" modelAttribute="guia" method="post" action="update">
							<input class="form-control" type="hidden" id="id" name="id" required="" value="${model.guiaObject.id}">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" type="text" id="nome" name="nome" required="" value="${model.guiaObject.nome}" >
                            </div>
                        </div>
                        <div class="form-group">
                        <label for="" class="col-sm-2 control-label"> Número Carteira: </label>
                        <div class="col-sm-3">
                           <input class="form-control" type="text" value="${model.guiaObject.numeroCarteira}" id="numeroCarteira" name="numeroCarteira" required="">
                        </div>
                        <label for="" class="col-sm-2 control-label"> Cartão Nacional de Saúde: </label>
                        <div class="col-sm-3">
                           <input class="form-control" type="text" value="${model.guiaObject.numeroCNS}" id="numeroCNS" name="numeroCNS" required="">
                           <br>
                        </div>
                     </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" type="text" id="email" name="email" value="${model.guiaObject.email}">
                            </div>
                        </div>
                       <c:forEach items="${model.guiaObject.telefone}" var="user" begin="0" end="3" varStatus="status">
                       ...
                       <input class="form-control" type="hidden" id="telefone" name="telefone[${status.count-1}].id" required="" value="${user.id}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input class="form-control" type="text" id="nascimento" name="nascimento" value="${model.guiaObject.nascimento}">
                            </div>
                             <label for="" class="col-sm-2 control-label">
                                Nacionalidade:
                            </label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" type="text" id="endereco" name="endereco" value="${model.guiaObject.endereco}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" type="text" id="cidade" name="cidade" value="${model.guiaObject.cidade}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" type="text" id="estado" name="estado" value="${model.guiaObject.estado}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" type="text" id="sexo" name="sexo" value="${model.guiaObject.sexo}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" type="text" id="nacionalidade" name="nacionalidade" value="${model.guiaObject.nacionalidade}">
                            </div>
                        </div>
