         ...
         <div class="example-box-wrapper">
            <div id="page-content">
               <div class="container">
                  <div class="page-box">
                     <h3 class="page-title">
                        Gerenciamento de Guias<small> Aqui você poderá buscar / editar e/ou excluir guias </small>
                     </h3>
                    ...
                    <div class="content-box remove-border dashboard-buttons center-div clearfix pad150T">
                        <a href="inserirBeneficiario" class="btn vertical-button remove-border btn-success" title="">
                            ...
                            <span class="button-content">Incluir <br>Guia</span>
                        </a>
                    </div>
                     ...
                     <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="dynamic-table-example-1">
                        ...
                        <tbody>
                           <c:forEach items="${guiaList}" var="user">
                              <tr class="odd gradeX">
                                 <td>
            ...
            <div class="modal-dialog">
               <div class="modal-content">
                  <div class="modal-header">
                     ...
                     <h4 class="modal-title">Deletar Guia</h4>
                  </div>
                  <div class="modal-body">
                     <p>Deseja realmente excluir a guia selecionado ? </p>
                  </div>
