   ...
   <tiles:putAttribute name="body">
      <div class="body">
         <div class="example-box-wrapper">
            <div id="page-content">
               <div class="container">
                  <div class="page-box">
                     <h3 class="page-title">
                        Gerenciamento de Operadora<small> Aqui você poderá buscar / editar e/ou excluir operadoras </small>
                     </h3>
                     
                    <div class="content-box remove-border dashboard-buttons center-div clearfix pad150T">
                        <a href="inserirOperadora" class="btn vertical-button remove-border btn-success" title="">
                            <span class="glyph-icon icon-separator-vertical">
                                <i class="glyph-icon icon-plus-circle"></i>
                            </span>
                            <span class="button-content">Incluir <br>Operadora</span>
                        </a>
                    </div>
                        ...
                        <tbody>
                           <c:forEach items="${operadoraList}" var="user">
                              <tr class="odd gradeX">
                                 ...
                                 <td>
                                    <c:out value="${user.registro_ans}" />
                                 </td>
                                 <td align="center">
                                    <a href="editOperadora?id=${user.id}" class="btn btn-info" title="Editar"> <i class="glyph-icon icon-edit"></i></a>
                                 </td>
                                 <td align="center">
            ...
            <div class="modal-dialog">
               <div class="modal-content">
                  <div class="modal-header">
                     ...
                     <h4 class="modal-title">Deletar Operadora</h4>
                  </div>
                  <div class="modal-body">
                     <p>Deseja realmente excluir o operadora selecionado ? </p>
                  </div>
         ...
         <script type="text/javascript">
            ...
            var userTeste = "";
            function setarID(id) {
             	 $("#testaaaa").attr("href","deleteOperadora?id=" + id);
             return true;
             }
