            ...
            <div class="container">
               <div class="page-box">
                  ...
                  <div class="content-box remove-border dashboard-buttons clearfix center-div pad150T">
                        <a href="#" class="btn vertical-button remove-border btn-success" title="">
                            <span class="glyph-icon icon-separator-vertical">
                                <i class="glyph-icon icon-plus-circle"></i>
                            </span>
                            <span class="button-content">Incluir</span>
                        </a>
                        <a href="#" class="btn vertical-button remove-border label-info" title="">
                            <span class="glyph-icon icon-separator-vertical">
                        ...
                        <a href="#" class="btn vertical-button remove-border label-danger" title="">
                            <span class="glyph-icon icon-separator-vertical">
                                <i class="glyph-icon icon-remove"></i>
                            </span>
                            <span class="button-content">Excluir</span>
                        </a>
                    </div>
               </div>
            </div>
